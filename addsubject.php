<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <br><br><br>
        <form action="db/addsubject.php" method="post">
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-text" id="inputGroup-sizing-lg">Enter the Subject name</span>
                <input type="text" class="form-control" name="subjectname" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
            </div><br><br><br>
